...
using RbsSampleApi.Domain.Languages.Features;
...
public class LanguagesController: ControllerBase
{
    ...
    public async Task<ActionResult<LanguageDto>> AddLanguage([FromBody]LanguageForCreationDto languageForCreation)
    {
        var command = new AddLanguage.AddLanguageCommand(languageForCreation);
        var commandResponse = await _mediator.Send(command);

        return CreatedAtRoute("GetLanguage",
    ...
    public async Task<ActionResult<LanguageDto>> GetLanguage(Guid id, [FromQuery] string[] includes)
    {
        var query = new GetLanguage.LanguageQuery(id, includes);
    ...
    public async Task<IActionResult> GetLanguages([FromQuery] LanguageParametersDto languageParametersDto)
    {
        var query = new GetLanguageList.LanguageListQuery(languageParametersDto);
        var queryResponse = await _mediator.Send(query);
    ...
    [ProducesResponseType(500)]
    [Produces("application/json")]
    [HttpPut("{id:guid}", Name = "UpdateLanguage")]
    public async Task<IActionResult> UpdateLanguage(Guid id, LanguageForUpdateDto language)
    {
        var command = new UpdateLanguage.UpdateLanguageCommand(id, language);
    ...
    [ProducesResponseType(500)]
    [Produces("application/json")]
    [HttpDelete("{id:guid}", Name = "DeleteLanguage")]
    public async Task<ActionResult> DeleteLanguage(Guid id)
    {
        var command = new DeleteLanguage.DeleteLanguageCommand(id);
        await _mediator.Send(command);
