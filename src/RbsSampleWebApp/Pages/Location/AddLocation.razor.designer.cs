...
namespace RbsSampleWebApp.Pages
{
    public partial class AddLocationComponent : ComponentBase
    {
        ...
        protected async System.Threading.Tasks.Task Load()
        {
            ...
            location = new RbsSampleWebApp.Models.RbsSampleDb.Location(){};
        }
        ...
        protected async System.Threading.Tasks.Task Form0Submit(RbsSampleWebApp.Models.RbsSampleDb.Location args)
        {
            try
            {
                var rbsSampleDbCreateLocationResult = await RbsSampleDb.CreateLocation(location);
                UriHelper.NavigateTo("locations");
            }
            catch (System.Exception rbsSampleDbCreateLocationException)
            {
